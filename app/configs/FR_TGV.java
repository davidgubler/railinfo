...
public class FR_TGV extends GtfsConfig {
    @Inject
    ...
    public GtfsConfig withDatabase(MongoDb mongoDb, String dbName, GtfsConfigModel gtfsConfigModel) {
        ...
        return new FR_TGV(db, ds);
    }

    @Override
    public String getDownloadUrl() {
        return "https://eu.ftp.opendatasoft.com/sncf/gtfs/export_gtfs_voyages.zip";
    }
    ...
    public FR_TGV(MongoDatabase db, Datastore ds) {
        this.db = db;
        this.ds = ds;
    }
